...
* timer using clearInterval. Returns "game stopped". The song is stopped and reset to beginning
*
*/
function stopGame(){ 
  gameSong.pause();  
  gameSong.currentTime = 0; // This line resets the song to the beginning
  clearInterval(timer);
  return "game stopped";
}
